...
(function(){
    ...
    function initMap() {
        var coordinates = {lat: 50.45466, lng: 30.5238},
    ...
    recipes.addEventListener('click', function(event) {
        ...
        if(event.target.className == 'recipes__cancel-btn') {
            ...
            if (window.innerWidth <= 768 && window.innerWidth >= 480) {
                recipes.style.width = '70%';
                recipes.parentElement.parentElement.querySelector('.subject--recipes').classList.remove('none-active');
            }
            // functional phone
            //-------------------------------
        ...
        if(event.target.className == 'recipes__title') {
            recipes.querySelectorAll('.recipes__item--active').forEach(function(item){
                ...
                item.querySelector('.recipes__desc').classList.add('close-desc');
            });
            ...
            if (window.innerWidth <= 768) {
                ...
                recipes.parentElement.parentElement.querySelector('.subject--recipes').classList.add('none-active');
            }
